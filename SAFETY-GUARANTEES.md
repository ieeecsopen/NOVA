...
[OWNERSHIP-MODEL.md](OWNERSHIP-MODEL.md)'s mechanism claims, at the
[Guarantee-ladder](LANGUAGE-CONSTITUTION.md#principle-7--verification-strength-must-be-explicit)
...
identity (`InRegion[T]`, [OWNERSHIP-MODEL.md §3](OWNERSHIP-MODEL.md#3-regions-are-capabilities--syntax-and-typing)).
...
**Mechanism.** In NOVA's actual design ([OWNERSHIP-MODEL.md §5](OWNERSHIP-MODEL.md#5-what-the-checker-verifies)
...
**Mechanism.** [OWNERSHIP-MODEL.md §2](OWNERSHIP-MODEL.md#2-the-core-claim-stated-as-a-typing-discipline)'s
...
[OWNERSHIP-MODEL.md §6](OWNERSHIP-MODEL.md#6-interaction-with-phase-2s-type-system)'s
...
([OWNERSHIP-MODEL.md §7](OWNERSHIP-MODEL.md#7-open-questions) item 3),
...
[OWNERSHIP-MODEL.md §7](OWNERSHIP-MODEL.md#7-open-questions) lists these
