...
> **Resolved, Milestone 1 —** [MEMORY-MODEL.md](../docs/language/MEMORY-MODEL.md),
> [OWNERSHIP-MODEL.md](../docs/language/OWNERSHIP-MODEL.md). The forced choice above was
...
[NON-GOALS.md](../docs/foundation/NON-GOALS.md).
