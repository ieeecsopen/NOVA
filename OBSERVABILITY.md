...
**Cross-References:** [RUNTIME-DIAGNOSTICS.md](RUNTIME-DIAGNOSTICS.md), [TRACING-MODEL.md](TRACING-MODEL.md), [docs/experiments/002-rows-to-spans.md](docs/experiments/002-rows-to-spans.md), [EFFECT-SYSTEM.md](EFFECT-SYSTEM.md), [CAPABILITY-MODEL.md](CAPABILITY-MODEL.md)
