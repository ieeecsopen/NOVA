...
Every claim in [SAFETY-GUARANTEES.md](SAFETY-GUARANTEES.md) is checked
...
4. **Lifetime elision is large, useful, and partially opaque.** Most
   ...
   ([LANGUAGE-CONSTITUTION.md Principle 9](LANGUAGE-CONSTITUTION.md#principle-9--ordinary-code-should-remain-simple)):
...
5. **Mutability polymorphism doesn't exist, so APIs triple.**
   ...
   ([PROBLEM-SPACE.md P5](PROBLEM-SPACE.md#p5--function-coloring-and-the-absence-of-effect-polymorphism))
...
([PROBLEM-SPACE.md P1](PROBLEM-SPACE.md#p1--memory-safety-still-costs-too-much-programmer-effort)'s
...
**Regions are the option [RESEARCH.md](RESEARCH.md#r1--memory-safety)
and [COMPETITIVE-ANALYSIS.md](COMPETITIVE-ANALYSIS.md#3-memory-management-in-detail)
...
[RESEARCH.md §R4](RESEARCH.md#r4--capability-security). NOVA's specific
