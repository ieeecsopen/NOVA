...
[COMPETITIVE-ANALYSIS.md](../../research/COMPETITIVE-ANALYSIS.md) already documents the
...
account and [LANGUAGE-PHILOSOPHY.md entry 8](../foundation/LANGUAGE-PHILOSOPHY.md#8-effect)
...
before one does. See [NON-GOALS.md](../foundation/NON-GOALS.md) for the full,
reasoned list.
...
Verified, not merely argued: [SAFETY-GUARANTEES.md §2](../../research/SAFETY-GUARANTEES.md#2-sendshare-verified-rather-than-merely-argued).
...
[Constitutional Principle 10](../foundation/LANGUAGE-CONSTITUTION.md#principle-10--advanced-features-must-not-contaminate-simple-programs-unnecessarily).
