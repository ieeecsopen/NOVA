...
([LANGUAGE-PHILOSOPHY.md entry 3](../foundation/LANGUAGE-PHILOSOPHY.md#3-program)):
...
See [docs/diagnostics.md](../diagnostics.md) for the full index. New
...
See [NON-GOALS.md](../foundation/NON-GOALS.md) and TYPE-SYSTEM.md §10 for the full,
