...
Extends [LANGUAGE-PHILOSOPHY.md](../foundation/LANGUAGE-PHILOSOPHY.md); new terms:
...
- **Region.** A contiguous lifetime scope that owns a set of heap
  ...
  capability* (§3) — [LANGUAGE-PHILOSOPHY.md entry 7](../foundation/LANGUAGE-PHILOSOPHY.md#7-capability)'s
...
which [DESIGN-OPPORTUNITIES.md Theme B](../../research/DESIGN-OPPORTUNITIES.md#3-theme-b--ownership-scope-and-lifetime-are-one-mechanism)
...
4. **Interaction with effect-row grading** ([RFC 0001 §11.7](../../RFC/0001-core-capability-effects.md#11-open-questions),
   ...
   [Experiment 003](../experiments/003-graded-rows.md)): does a
...
See [SAFETY-GUARANTEES.md](../../research/SAFETY-GUARANTEES.md) for the claims this
