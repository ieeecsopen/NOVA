...
- **Capabilities, Effects, and Resources are not independent peers.**
  [DESIGN-OPPORTUNITIES.md Theme A](../research/DESIGN-OPPORTUNITIES.md#2-theme-a--obligations-are-one-mechanism),
...
- **Verification is not a peer ingredient** — it is an axis (the
  Guarantee ladder, [LANGUAGE-PHILOSOPHY.md entry 10](foundation/LANGUAGE-PHILOSOPHY.md#10-guarantee))
...
- **Uncertainty is a property of values**, not of programs — demoted to
  a note ([RESEARCH.md §R10](../research/RESEARCH.md#r10--uncertainty),
  [NON-GOALS.md §2.4](foundation/NON-GOALS.md#24-uncertainty-as-a-language-feature)).
...
Full argument: [PROGRAM-MODEL.md](foundation/PROGRAM-MODEL.md). Article II now
...
designed one — [MEMORY-MODEL.md](language/MEMORY-MODEL.md) selects
...
assume Rust's model is optimal; [OWNERSHIP-MODEL.md](language/OWNERSHIP-MODEL.md)
