...
which is exactly the claim [Experiments 001–003](../experiments)
tested.
...
2. is bounded by an explicit **grade** on that capability — a cost or
   ...
   [Experiment 003](../experiments/003-graded-rows.md) already found
...
[Experiment 003](../experiments/003-graded-rows.md) implemented
